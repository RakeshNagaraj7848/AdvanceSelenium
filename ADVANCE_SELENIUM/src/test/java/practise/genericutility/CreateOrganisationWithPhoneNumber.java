...
public class CreateOrganisationWithPhoneNumber {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String phoneNumber=d.formatCellValue(cell1);
		wb.close();
	...
	// click on save button
	  ...
	  //   step 5  verify phonenumber
		String actualPhoneNumber=driver.findElement(By.id("dtlview_Phone")).getText();
		if(actualPhoneNumber.equals(phoneNumber))
		{
			System.out.println("organisation with this"+ phoneNumber+ "is craered sucessfull  test =pass");
		}
		else
	
			{
				System.out.println("organisation with this"+ phoneNumber+ "is  not craered sucessfull  test =fail");
			}
